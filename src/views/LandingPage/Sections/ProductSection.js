      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={12} lg={10}>
          ...
          <h5 className={classes.description}>
            ...
            J3 and Semoan-Ramit-Raboya. Exploration has been mainly concentrated
            on the Lemonga gold-silver epithermal vein prospect which shows
            substantial potential exploration upside.
          </h5>
        </GridItem>
      </GridContainer>
